  ...
  const features = [
    {
      ...
      title: "Zero-Cost Fun",
      desc: "All ideas use stuff you already own.",
    },
    {
      icon: (
        <svg
      ...
      desc: "Perfect for kids, teens, and playful adults.",
    },
    {
      icon: (
        <svg
      ...
      title: "Quick Start",
      desc: "Most activities take 10 minutes or less to set up.",
    },
  ];
  ...
  return (
    <section className="py-14">
      <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8 ">
        <div className="max-w-full space-y-3 sm:text-center">
